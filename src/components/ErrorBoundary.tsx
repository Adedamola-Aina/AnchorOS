        ...
        if (this.state.hasError) {
            ...
            return (
                <div className="min-h-[300px] flex items-center justify-center p-6">
                    <div className="max-w-lg w-full bg-surface-1 dark:bg-surface-1-dark rounded-2xl shadow-xl border border-danger-200 dark:border-danger-500/30 overflow-hidden">
                        {/* Header */}
                        ...
                        <div className="p-4 border-b border-border-subtle">
                            <p className="text-sm font-mono text-danger-600 dark:text-danger-400 bg-danger-50 dark:bg-danger-900/20 p-3 rounded-lg break-all">
                        ...
                        <div className="border-t border-border-subtle">
                            <button
                                ...
                                className="w-full p-3 flex items-center justify-between text-sm text-muted hover:bg-surface-2 dark:hover:bg-surface-2-dark transition-colors"
                            >
