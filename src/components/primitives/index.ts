 ...
 * 
 * DES-002 + DES-001: Core primitive components for consistent UI
 * 
 * These replace raw Tailwind classes with semantic, reusable components.
 * Import from this file for all primitive UI needs.
 * 
 * Usage:
 *   import { Text, Surface, Stack, Badge, Card } from '@/components/primitives';
 */
