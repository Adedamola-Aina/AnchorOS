...
export const seedData = async (userId: string) => {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        const newAccount: AnchorAccount = {
            ...
            balanceCents: Math.floor(Math.random() * 800000) + 5000, color: ACCOUNT_COLORS[i],
