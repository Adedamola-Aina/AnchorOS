...
import { buildWeekBuckets, detectPrimaryCurrency, formatCents, getDateRange, getHighSpendDay, getSpendingByDayOfWeek, sumByCategory, toDate, withinRange } from './fabricUtils';
...
export function buildInsights(input: InsightInput): Insight[] {
  ...
  // Dashboard: correlation first (highest value), then spending + commitments + streak + savings + day-of-week
