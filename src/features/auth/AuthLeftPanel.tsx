...
export function AuthLeftPanel() {
    return (
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-surface-2-dark via-surface-1-dark to-surface-1-dark dark:from-surface-1-dark dark:via-surface-1-dark dark:to-black">
