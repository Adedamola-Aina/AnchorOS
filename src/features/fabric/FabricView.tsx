...
const FabricView: React.FC = () => {
  ...
  if (!isEnabled) {
    return (
      <FeatureErrorBoundary featureName="Anchor AI">
        <div className="max-w-3xl mx-auto space-y-4 pb-28 md:pb-20">
  ...
  return (
    <FeatureErrorBoundary featureName="Anchor AI">
      <div data-testid="fabric-view" className="max-w-3xl mx-auto space-y-5 pb-28 md:pb-20 animate-in fade-in duration-300">
