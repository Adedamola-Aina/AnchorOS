 ...
 * featuresParser.js
 *
 * Pure parsing logic for FEATURE_SUGGESTIONS.md.
 * Extracted from features.js to keep files ≤200 lines (ARCH-001).
 */
...
function parseFeatureSuggestions(markdown) {
    ...
    return { features: pendingFeatures, completedFeatures, grouped, summary };
}

module.exports = { parseFeatureSuggestions, CATEGORY_MAP };
