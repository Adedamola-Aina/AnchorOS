...
exports.migrateFamilyConnectionsV2 = void 0;
...
// ============================================================================
exports.migrateFamilyConnectionsV2 = (0, https_1.onCall)(async (request) => {
    if (!request.auth) {
    ...
    const results = [];
    try {
        const usersRef = config_1.db.collection('artifacts').doc(config_1.APP_ID).collection('users');
        ...
        for (const userDoc of usersSnapshot.docs) {
            ...
            await (0, helpers_1.createAuditLog)(ownerUid, 'migration_v1_to_v2', {
        ...
        throw new https_1.HttpsError('internal', 'Migration failed: ' + error.message);
    }
});
//# sourceMappingURL=familyMigration.js.map