...
export function AuthLeftPanel() {
  if (stryMutAct_9fa48("2002")) {
    ...
    stryCov_9fa48("2002");
    return <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-slate-800 via-slate-900 to-slate-950 dark:from-slate-900 dark:via-slate-950 dark:to-black">
            <div className="absolute inset-0 z-0">
                <svg className="absolute bottom-0 left-0 w-full opacity-20 dark:opacity-10" viewBox="0 0 1440 320" preserveAspectRatio="none" style={stryMutAct_9fa48("2003") ? {} : (stryCov_9fa48("2003"), {
          height: stryMutAct_9fa48("2004") ? "" : (stryCov_9fa48("2004"), '50%')
        })}>
                ...
                <svg className="absolute bottom-0 left-0 w-full opacity-30 dark:opacity-15" viewBox="0 0 1440 320" preserveAspectRatio="none" style={stryMutAct_9fa48("2005") ? {} : (stryCov_9fa48("2005"), {
          height: stryMutAct_9fa48("2006") ? "" : (stryCov_9fa48("2006"), '35%')
        })}>
